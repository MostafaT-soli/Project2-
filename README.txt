...
This is an advanced version for Project 1 , and it's desighned for a specfic guild .
...
3-Var File should be completed , then DB Create script must run before running the main script .
